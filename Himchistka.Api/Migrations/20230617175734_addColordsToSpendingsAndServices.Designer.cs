...
namespace Himchistka.Api.Migrations
{
    ...
    [Migration("20230617175734_addColordsToSpendingsAndServices")]
    partial class addColordsToSpendingsAndServices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Himchistka.Data.Connections.SpendingServices", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Himchistka.Data.Entities.Spending", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Himchistka.Data.Connections.SpendingServices", b =>
                {
                    ...
                    b.HasOne("Himchistka.Data.Entities.Spending", "Spending")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("Himchistka.Data.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Himchistka.Data.Entities.Place", "Place")
                        .WithMany("Orders")
